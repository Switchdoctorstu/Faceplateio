<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeCtl.aspx.cs" Inherits="faceplateio.HomeCtl" %>
    ...
    <asp:LoginStatus ID="LoginStatus1" runat="server" />
        ...
        <div>
         ...
         <div>
             ...
             <input id="AddControllerButton" type="button" value ="Add Controller" onclick="window.open('AddDevice.aspx', 'Devices');" />
